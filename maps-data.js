    ...
    skills: [
      {
        ...
        download: true,
        note: "Starts M0 Project Foundation with a one-question-at-a-time memory-first preflight, project intent, notes scaffold, Git readiness, env/secrets scaffold, incremental foundation audits, EventStorming Lite, Service Blueprint Lite, source inventory, evidence index, assumptions, decisions, RAG-readiness, persistent memory contract, maps-run helper notes named [project]-[skill]-helper-notes, role-[role-name] notes, RAG mirrors, run log, remembered notes/RAG locations, and /foundation --wipe reset support."
      },
      {
        name: "/shape",
