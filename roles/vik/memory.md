...
- ASPA agent definition, design, and runtime-neutral build proof are complete through `/build-agent`, but promotion is paused. Next work should be guardrail hardening and evaluation before `/equip-agent`, runtime target selection, adapter work, or Agent promotion resumes.
