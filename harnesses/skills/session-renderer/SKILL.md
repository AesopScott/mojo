...
description: Use when working on the Interface harness and you need a repeatable performance control: Virtualizes large session lists and throttles refresh cadence so the command center stays responsive at high session counts.
---
...
- You are designing or reviewing the Interface harness.
...
1. Identify the controlled boundary for the Interface harness.
