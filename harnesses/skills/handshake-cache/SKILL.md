...
description: Use when working on the Network Protocol harness and you need a repeatable performance control: Caches trust handshakes and batches signature verification so multi-node calls add less per-packet latency.
---
...
- You are designing or reviewing the Network Protocol harness.
...
1. Identify the controlled boundary for the Network Protocol harness.
