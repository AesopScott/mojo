---
name: scope-tuner
description: Use when working on the Privacy harness and you need a repeatable cost efficiency control: Tunes scan scope to the data actually present, avoiding full-payload scanning cost.
---
