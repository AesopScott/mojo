...
description: Use when working on the Session Manager harness and you need a repeatable capability control: Exposes recovery-strategy scripts, worktree-isolation rules, and open/close lifecycle hooks for custom session behavior.
---
