---
name: scoped-guards
description: Use when working on the Safety harness and you need a repeatable cost efficiency control: Scopes guard checks by risk so low-risk calls run fewer checks.
---
