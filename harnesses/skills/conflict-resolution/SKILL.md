...
description: Use when working on the Memory harness and you need a repeatable capability control: Adds a memory schema, conflict-resolution logic, and provenance depth so recall stays trustworthy under contradiction.
---
