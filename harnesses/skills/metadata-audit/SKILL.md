---
name: metadata-audit
description: Use when working on the Payload harness and you need a repeatable cost efficiency control: Stores hash-only metadata instead of full payloads for cheap auditability.
---
