...
description: Use when working on the Prompt harness and you need a repeatable capability control: Adds a template library and injection-order rules for new prompt shapes.
---
