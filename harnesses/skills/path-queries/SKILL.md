---
name: path-queries
description: Use when working on the File Navigation harness and you need a repeatable capability control: Adds ownership-rule sources, a capability-mapping schema, and custom capability-to-code-to-proof queries.
---
