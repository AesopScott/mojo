---
name: scaled-review
description: Use when working on the Review Queue harness and you need a repeatable cost efficiency control: Sets review depth and reviewer-model tier by severity and skips trivial findings to control review spend.
---
