---
name: speed-matcher
description: Use when working on the Select harness and you need a repeatable performance control: Weights capability matching toward faster candidates when task quality permits.
---
