---
name: batch-mode
description: Use when working on the Latency harness and you need a repeatable cost efficiency control: Trades latency for cheaper batch processing where the task tolerates delay.
---
