...
description: Use when working on the Prompt harness and you need a repeatable performance control: Precompiles templates and reuses cache prefixes so prompt assembly is fast.
---
