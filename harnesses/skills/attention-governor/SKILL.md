...
description: Use when working on the Orchestrator harness and you need a repeatable cost efficiency control: Caps concurrent high-cost reasoning sessions per project and reclaims idle slices, holding total attention spend under a set ceiling.
---
