---
name: finding-dedup
description: Use when working on the Review Queue harness and you need a repeatable performance control: Collapses duplicate findings and batches clusters across parallel reviewer lanes so the queue clears faster.
---
...
- You are designing or reviewing the Review Queue harness.
...
1. Identify the controlled boundary for the Review Queue harness.
