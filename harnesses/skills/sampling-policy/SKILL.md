...
description: Use when working on the Verify harness and you need a repeatable performance control: Verifies a sampled subset rather than every call where risk allows, cutting verification latency.
---
...
- You are designing or reviewing the Verify harness.
...
1. Identify the controlled boundary for the Verify harness.
