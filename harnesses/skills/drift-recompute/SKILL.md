...
description: Use when working on the Project Scope harness and you need a repeatable performance control: Recomputes only changed scope regions and caches the dependency graph so drift checks stay cheap and current.
---
