---
name: tiered-verifier
description: "Use when working on the Verify harness and you need cost efficiency control: Scales verification effort to risk tier so low-risk calls aren't over-verified."
---
...
- Command: /tiered-verifier

## What This Skill Does

Scales verification effort to risk tier so low-risk calls aren't over-verified.
...
1. Name the exact boundary: `Verify` / `Cost efficiency`.
...
2. Write the observed failure mode in one sentence: "Tiered Verifier is needed because ..."
...
- Positive test: a normal request uses `Tiered Verifier` and produces the expected controlled behavior.
...
```markdown
## Tiered Verifier Harness Update

Boundary: Verify / Cost efficiency
