---
name: proof-registry
description: "Use when working on the Proof Authority harness and you need capability control: Registers new evidence types and sufficiency thresholds so the authority can score domains it could not before."
---
...
- Axis: Capability
- Command: /proof-registry

## What This Skill Does

Registers new evidence types and sufficiency thresholds so the authority can score domains it could not before.
...
1. Name the exact boundary: `Proof Authority` / `Capability`.
...
- Proof-type registry (plugin)
- Sufficiency thresholds
- Waiver policy authoring
...
2. Write the observed failure mode in one sentence: "Proof Registry is needed because ..."
...
- Positive test: a normal request uses `Proof Registry` and produces the expected controlled behavior.
...
```markdown
## Proof Registry Harness Update

Boundary: Proof Authority / Capability
