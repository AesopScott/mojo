---
name: proof-registry
description: Use when working on the Proof Authority harness and you need a repeatable capability control: Registers new evidence types and sufficiency thresholds so the authority can score domains it could not before.
---
