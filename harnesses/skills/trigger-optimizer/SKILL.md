...
description: Use when working on the Guardrails harness and you need a repeatable cost efficiency control: Moves scans to high-value trigger points (pre-commit over continuous) and batches rules to reduce guardrail compute.
---
