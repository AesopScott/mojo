---
name: cheap-pinner
description: Use when working on the Identity harness and you need a repeatable cost efficiency control: Pins to the cheapest sufficient model version when capability allows, lowering per-call cost.
---
