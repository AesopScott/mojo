...
description: Use when working on the Evidence harness and you need a repeatable performance control: Gathers evidence across sources in parallel to shorten linking time.
---
