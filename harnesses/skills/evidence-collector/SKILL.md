...
description: "Use when working on the Evidence harness and you need performance control: Gathers evidence across sources in parallel to shorten linking time."
---
...
Gathers evidence across sources in parallel to shorten linking time.
...
1. Name the exact boundary: `Evidence` / `Performance`.
...
2. Write the observed failure mode in one sentence: "Evidence Collector is needed because ..."
...
- Positive test: a normal request uses `Evidence Collector` and produces the expected controlled behavior.
...
```markdown
## Evidence Collector Harness Update

Boundary: Evidence / Performance
