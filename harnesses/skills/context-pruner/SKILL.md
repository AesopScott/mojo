---
name: context-pruner
description: Use when working on the Goal harness and you need a repeatable cost efficiency control: Drops context not tied to the active objective to save tokens.
---
