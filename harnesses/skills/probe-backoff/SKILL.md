---
name: probe-backoff
description: Use when working on the Health Monitor harness and you need a repeatable cost efficiency control: Backs off probe frequency on idle sessions and samples instead of per-tick polling to cut monitoring overhead.
---
