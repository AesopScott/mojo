...
description: Use when working on the Provider harness and you need a repeatable cost efficiency control: Chooses batch over realtime endpoints and compresses payloads where latency allows to reduce vendor cost.
---
