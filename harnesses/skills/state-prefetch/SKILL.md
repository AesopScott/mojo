---
name: state-prefetch
description: Use when working on the Session Manager harness and you need a repeatable performance control: Batches write-through and prefetches resume state so session open, resume, and worktree migration run with less stall.
---
