---
name: route-table
description: Use when working on the Route harness and you need a repeatable capability control: Adds a configurable route table and dispatch hooks for new model paths.
---
