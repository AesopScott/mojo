...
description: Use when working on the Evidence harness and you need a repeatable capability control: Adds connectors and a link schema so output ties to new validation sources.
---
...
- You are designing or reviewing the Evidence harness.
...
1. Identify the controlled boundary for the Evidence harness.
