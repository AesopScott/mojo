---
name: process-hooks
description: Use when working on the Response harness and you need a repeatable capability control: Adds an artifact schema and post-process hooks for response handling.
---
