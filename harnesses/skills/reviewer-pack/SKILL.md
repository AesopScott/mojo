---
name: reviewer-pack
description: Use when working on the Review Queue harness and you need a repeatable capability control: Adds reviewer-agent sets, a configurable severity rubric, and a repair-verification gate.
---
