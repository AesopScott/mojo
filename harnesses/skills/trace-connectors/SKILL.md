...
description: Use when working on the Trace harness and you need a repeatable capability control: Adds a trace schema and export connectors for external audit sinks.
---
