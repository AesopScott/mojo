---
name: trace-connectors
description: "Use when working on the Trace harness and you need capability control: Adds a trace schema and export connectors for external audit sinks."
---
...
- Harness: Trace
- Axis: Capability
- Command: /trace-connectors

## What This Skill Does

Adds a trace schema and export connectors for external audit sinks.
...
- You are changing or reviewing the Trace harness.
...
1. Name the exact boundary: `Trace` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Trace Connectors is needed because ..."
...
- Positive test: a normal request uses `Trace Connectors` and produces the expected controlled behavior.
- Boundary test: an overreach, missing-input, unsafe, expensive, or unsupported request is blocked, downgraded, or escalated.
- Regression check: existing Trace behavior that should not change still works.
...
```markdown
## Trace Connectors Harness Update

Boundary: Trace / Capability
