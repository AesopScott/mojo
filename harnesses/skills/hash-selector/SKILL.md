---
name: hash-selector
description: Use when working on the Payload harness and you need a repeatable performance control: Picks a fast hash algorithm so fingerprinting adds minimal overhead.
---
