...
1. Name the exact boundary: `Cost` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Cost Model is needed because ..."
...
- Positive test: a normal request uses `Cost Model` and produces the expected controlled behavior.
