---
name: cost-model
description: Use when working on the Cost harness and you need a repeatable capability control: Adds per-provider cost models and budget-policy authoring.
---
