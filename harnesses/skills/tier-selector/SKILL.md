---
name: tier-selector
description: Use when working on the Select harness and you need a repeatable cost efficiency control: Defaults selection to the lowest tier that meets the task to avoid overpaying for capability.
---
