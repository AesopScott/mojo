---
name: graph-builder
description: Use when working on the File Navigation harness and you need a repeatable performance control: Builds the ownership graph incrementally, caps impact-walk depth, and caches paths so navigation stays fast on large trees.
---
...
- You are designing or reviewing the File Navigation harness.
...
1. Identify the controlled boundary for the File Navigation harness.
