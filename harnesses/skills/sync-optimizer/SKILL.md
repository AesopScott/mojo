---
name: sync-optimizer
description: Use when working on the Interface harness and you need a repeatable cost efficiency control: Replaces redundant polling with change-driven push updates and tuned snapshot intervals to cut wasted repaint and state-sync work.
---
