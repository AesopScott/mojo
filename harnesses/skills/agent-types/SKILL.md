---
name: agent-types
description: Use when working on the Sub-agent Dispatch harness and you need a repeatable capability control: Registers new agent types, pluggable planning strategies, and enforced result schemas.
---
