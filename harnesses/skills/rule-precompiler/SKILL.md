...
description: Use when working on the Policy harness and you need a repeatable performance control: Precompiles and caches constraint rules so policy evaluation adds little overhead.
---
...
- You are designing or reviewing the Policy harness.
...
1. Identify the controlled boundary for the Policy harness.
