---
name: goal-cache
description: Use when working on the Goal harness and you need a repeatable performance control: Caches the goal binding so each call reattaches to the objective without recompute.
---
