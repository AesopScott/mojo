...
description: Use when working on the Provider harness and you need a repeatable capability control: Adds per-vendor adapters and auth-mode config so new providers connect through the controlled boundary.
---
