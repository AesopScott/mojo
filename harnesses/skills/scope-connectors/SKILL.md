...
description: Use when working on the Project Scope harness and you need a repeatable capability control: Adds connectors and handoff templates so scope tracking spans new project and cross-project sources.
---
...
- You are designing or reviewing the Project Scope harness.
...
1. Identify the controlled boundary for the Project Scope harness.
