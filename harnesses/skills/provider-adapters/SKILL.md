...
description: Use when working on the Model Router harness and you need a repeatable capability control: Adds new vendor/model adapters and configurable fallback-chain depth without changing the routing core.
---
