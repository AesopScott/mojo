---
name: ci-gate
description: Use when working on the Git Control harness and you need a repeatable cost efficiency control: Minimizes branch-lease scope and gates CI triggers (rebase-vs-merge policy) to avoid redundant pipeline cost.
---
