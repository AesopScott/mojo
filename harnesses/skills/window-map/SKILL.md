---
name: window-map
description: Use when working on the Context harness and you need a repeatable capability control: Adds packing strategies and a per-model window map so context fit adapts to each model.
---
