---
name: main-gate
description: Use when working on the Git Control harness and you need a repeatable capability control: Adds branch-lease rules, risk-scoring weights, and a scripted main-write gate.
---
