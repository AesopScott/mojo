---
name: async-writer
description: Use when working on the Trace harness and you need a repeatable performance control: Writes traces asynchronously so audit logging doesn't block the call path.
---
