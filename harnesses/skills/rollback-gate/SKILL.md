---
name: rollback-gate
description: "Use when working on the Release Readiness harness and you need capability control: Adds rollback-gate policy, changelog templates, and configurable release-risk inputs."
---
...
- Axis: Capability
- Command: /rollback-gate

## What This Skill Does

Adds rollback-gate policy, changelog templates, and configurable release-risk inputs.
...
1. Name the exact boundary: `Release Readiness` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Rollback Gate is needed because ..."
...
- Positive test: a normal request uses `Rollback Gate` and produces the expected controlled behavior.
...
```markdown
## Rollback Gate Harness Update

Boundary: Release Readiness / Capability
