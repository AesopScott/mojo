---
name: rollback-gate
description: Use when working on the Release Readiness harness and you need a repeatable capability control: Adds rollback-gate policy, changelog templates, and configurable release-risk inputs.
---
