...
description: Use when working on the Compare harness and you need a repeatable capability control: Adds comparison/voting strategies and configurable juror sets.
---
