---
name: trust-cache
description: Use when working on the Trust harness and you need a repeatable performance control: Caches trust state so valid routes skip redundant lookups.
---
