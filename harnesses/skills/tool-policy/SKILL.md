---
name: tool-policy
description: Use when working on the Tools harness and you need a repeatable capability control: Configures the allowed-tool set and tool-call policy per route.
---
