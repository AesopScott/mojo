...
description: Use when working on the Policy harness and you need a repeatable cost efficiency control: Adds a constraint that forces the cheapest allowed tier when policy permits.
---
