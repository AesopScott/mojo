---
name: stall-tuner
description: Use when working on the Health Monitor harness and you need a repeatable performance control: Calibrates heartbeat interval, stall threshold, and anomaly window so genuine stalls surface fast without false alarms.
---
