---
name: juror-panel
description: Use when working on the Compare harness and you need a repeatable cost efficiency control: Caps lane count and uses cheaper juror models to bound comparison cost.
---
