...
description: Use when working on the Select harness and you need a repeatable capability control: Adds an authored selection rubric and capability catalog so new task types map to the right model.
---
...
- You are designing or reviewing the Select harness.
...
1. Identify the controlled boundary for the Select harness.
