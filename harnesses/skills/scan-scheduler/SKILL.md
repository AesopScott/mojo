---
name: scan-scheduler
description: "Use when working on the Project Scope harness and you need cost efficiency control: Tunes scope-scan frequency and prefers incremental over full ontology rebuilds to limit recompute cost."
---
...
- Command: /scan-scheduler

## What This Skill Does

Tunes scope-scan frequency and prefers incremental over full ontology rebuilds to limit recompute cost.
...
1. Name the exact boundary: `Project Scope` / `Cost efficiency`.
...
- Scope-scan frequency
- Incremental vs. full ontology rebuild
...
2. Write the observed failure mode in one sentence: "Scan Scheduler is needed because ..."
...
- Positive test: a normal request uses `Scan Scheduler` and produces the expected controlled behavior.
...
```markdown
## Scan Scheduler Harness Update

Boundary: Project Scope / Cost efficiency
