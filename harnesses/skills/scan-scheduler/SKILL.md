---
name: scan-scheduler
description: Use when working on the Project Scope harness and you need a repeatable cost efficiency control: Tunes scope-scan frequency and prefers incremental over full ontology rebuilds to limit recompute cost.
---
