---
name: redaction-packs
description: "Use when working on the Privacy harness and you need capability control: Adds redaction patterns and data-class policy for new sensitive-data types."
---
...
- Harness: Privacy
- Axis: Capability
- Command: /redaction-packs

## What This Skill Does

Adds redaction patterns and data-class policy for new sensitive-data types.
...
1. Name the exact boundary: `Privacy` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Redaction Packs is needed because ..."
...
- Positive test: a normal request uses `Redaction Packs` and produces the expected controlled behavior.
...
```markdown
## Redaction Packs Harness Update

Boundary: Privacy / Capability
