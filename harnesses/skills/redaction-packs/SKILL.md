...
description: Use when working on the Privacy harness and you need a repeatable capability control: Adds redaction patterns and data-class policy for new sensitive-data types.
---
...
- You are designing or reviewing the Privacy harness.
...
1. Identify the controlled boundary for the Privacy harness.
