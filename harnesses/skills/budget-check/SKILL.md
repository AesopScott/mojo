---
name: budget-check
description: Use when working on the Cost harness and you need a repeatable performance control: Checks budget before dispatch so over-budget work is stopped before it spends.
---
