...
description: Use when working on the File Navigation harness and you need a repeatable cost efficiency control: Re-indexes only changed regions and applies partial graph updates to avoid full-rebuild cost.
---
