...
description: Use when working on the Sub-agent Dispatch harness and you need a repeatable performance control: Tunes lane concurrency and fan-out and prefers pipeline over barrier stages so sub-agent work overlaps instead of waiting.
---
