...
description: Use when working on the Compare harness and you need a repeatable performance control: Runs comparison lanes in parallel and exits on early consensus to save time.
---
...
- You are designing or reviewing the Compare harness.
...
1. Identify the controlled boundary for the Compare harness.
