...
description: "Use when working on the Compare harness and you need performance control: Runs comparison lanes in parallel and exits on early consensus to save time."
---
...
- Harness: Compare
- Axis: Performance
- Command: /early-consensus

## What This Skill Does

Runs comparison lanes in parallel and exits on early consensus to save time.
...
1. Name the exact boundary: `Compare` / `Performance`.
...
2. Write the observed failure mode in one sentence: "Early Consensus is needed because ..."
...
- Positive test: a normal request uses `Early Consensus` and produces the expected controlled behavior.
...
```markdown
## Early Consensus Harness Update

Boundary: Compare / Performance
