---
name: trust-machine
description: "Use when working on the Trust harness and you need capability control: Adds a configurable trust-state machine and expiry policy for route trust."
---
...
- Harness: Trust
- Axis: Capability
- Command: /trust-machine

## What This Skill Does

Adds a configurable trust-state machine and expiry policy for route trust.
...
1. Name the exact boundary: `Trust` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Trust Machine is needed because ..."
...
- Positive test: a normal request uses `Trust Machine` and produces the expected controlled behavior.
...
```markdown
## Trust Machine Harness Update

Boundary: Trust / Capability
