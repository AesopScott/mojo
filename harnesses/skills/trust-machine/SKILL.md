---
name: trust-machine
description: Use when working on the Trust harness and you need a repeatable capability control: Adds a configurable trust-state machine and expiry policy for route trust.
---
...
- You are designing or reviewing the Trust harness.
...
1. Identify the controlled boundary for the Trust harness.
