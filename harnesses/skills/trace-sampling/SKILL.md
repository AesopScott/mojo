---
name: trace-sampling
description: "Use when working on the Trace harness and you need cost efficiency control: Samples and ages out traces under a retention budget to limit storage cost."
---
...
1. Name the exact boundary: `Trace` / `Cost efficiency`.
...
2. Write the observed failure mode in one sentence: "Trace Sampling is needed because ..."
...
- Positive test: a normal request uses `Trace Sampling` and produces the expected controlled behavior.
...
```markdown
## Trace Sampling Harness Update

Boundary: Trace / Cost efficiency
