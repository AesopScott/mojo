---
name: scaled-gates
description: Use when working on the Release Readiness harness and you need a repeatable cost efficiency control: Scales gate-check scope to release size and reuses prior proof bundles to cut release-prep cost.
---
