...
1. Name the exact boundary: `Tools` / `Cost efficiency`.
...
2. Write the observed failure mode in one sentence: "Call Ceiling is needed because ..."
...
- Positive test: a normal request uses `Call Ceiling` and produces the expected controlled behavior.
