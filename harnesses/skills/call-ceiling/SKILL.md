---
name: call-ceiling
description: Use when working on the Tools harness and you need a repeatable cost efficiency control: Caps tool calls per request so a run can't overspend on tool use.
---
