...
description: "Use when working on the Network Protocol harness and you need capability control: Adds transport adapters, node-trust policy, and a capability-advertisement schema for new node types."
---
...
- Axis: Capability
- Command: /transport-adapters

## What This Skill Does

Adds transport adapters, node-trust policy, and a capability-advertisement schema for new node types.
...
1. Name the exact boundary: `Network Protocol` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Transport Adapters is needed because ..."
...
- Positive test: a normal request uses `Transport Adapters` and produces the expected controlled behavior.
...
```markdown
## Transport Adapters Harness Update

Boundary: Network Protocol / Capability
