...
description: Use when working on the Network Protocol harness and you need a repeatable capability control: Adds transport adapters, node-trust policy, and a capability-advertisement schema for new node types.
---
