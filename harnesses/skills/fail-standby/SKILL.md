---
name: fail-standby
description: Use when working on the Fallback harness and you need a repeatable performance control: Sets tight fail timeouts and keeps a pre-warmed standby so blocked routes recover quickly.
---
