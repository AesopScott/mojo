---
name: safety-packs
description: "Use when working on the Safety harness and you need capability control: Adds installable safety rule packs and block/allow policy."
---
...
- Harness: Safety
- Axis: Capability
- Command: /safety-packs

## What This Skill Does

Adds installable safety rule packs and block/allow policy.
...
1. Name the exact boundary: `Safety` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Safety Packs is needed because ..."
...
- Positive test: a normal request uses `Safety Packs` and produces the expected controlled behavior.
...
```markdown
## Safety Packs Harness Update

Boundary: Safety / Capability
