---
name: safety-packs
description: Use when working on the Safety harness and you need a repeatable capability control: Adds installable safety rule packs and block/allow policy.
---
