...
description: Use when working on the Verify harness and you need a repeatable capability control: Adds scripted checks and an evidence schema so new output types can be confirmed.
---
