---
name: panel-kit
description: "Use when working on the Interface harness and you need capability control: Provides a plugin surface for operator-authored panels, widgets, and layout presets like this harness drawer."
---
...
Provides a plugin surface for operator-authored panels, widgets, and layout presets like this harness drawer.
...
1. Name the exact boundary: `Interface` / `Capability`.
...
- Custom panels / widgets (plugin)
- Layout presets
- Drawer extensions like this one
...
2. Write the observed failure mode in one sentence: "Panel Kit is needed because ..."
...
- Positive test: a normal request uses `Panel Kit` and produces the expected controlled behavior.
...
```markdown
## Panel Kit Harness Update

Boundary: Interface / Capability
