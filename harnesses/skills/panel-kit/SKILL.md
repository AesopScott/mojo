---
name: panel-kit
description: Use when working on the Interface harness and you need a repeatable capability control: Provides a plugin surface for operator-authored panels, widgets, and layout presets like this harness drawer.
---
