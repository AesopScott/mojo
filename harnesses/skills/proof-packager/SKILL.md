---
name: proof-packager
description: "Use when working on the Release Readiness harness and you need performance control: Builds proof packages in parallel and tunes the risk-forecast model so release readiness is assessed faster."
---
...
- Axis: Performance
- Command: /proof-packager

## What This Skill Does

Builds proof packages in parallel and tunes the risk-forecast model so release readiness is assessed faster.
...
1. Name the exact boundary: `Release Readiness` / `Performance`.
...
2. Write the observed failure mode in one sentence: "Proof Packager is needed because ..."
...
- Positive test: a normal request uses `Proof Packager` and produces the expected controlled behavior.
...
```markdown
## Proof Packager Harness Update

Boundary: Release Readiness / Performance
