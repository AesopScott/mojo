---
name: proof-packager
description: Use when working on the Release Readiness harness and you need a repeatable performance control: Builds proof packages in parallel and tunes the risk-forecast model so release readiness is assessed faster.
---
...
- You are designing or reviewing the Release Readiness harness.
...
1. Identify the controlled boundary for the Release Readiness harness.
