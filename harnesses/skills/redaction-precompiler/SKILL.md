...
description: Use when working on the Privacy harness and you need a repeatable performance control: Precompiles redaction matchers so leakage scanning stays fast.
---
