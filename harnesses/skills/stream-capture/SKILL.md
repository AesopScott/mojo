---
name: stream-capture
description: Use when working on the Response harness and you need a repeatable performance control: Captures responses as a stream rather than blocking so downstream work starts sooner.
---
