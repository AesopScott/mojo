---
name: skip-reviewer
description: Use when working on the Trust harness and you need a repeatable cost efficiency control: Skips re-review while trust remains valid to avoid repeat review cost.
---
