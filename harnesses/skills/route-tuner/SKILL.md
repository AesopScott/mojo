---
name: route-tuner
description: Use when working on the Model Router harness and you need a repeatable performance control: Continuously retunes latency-vs-quality route weights and keeps warm pools ready so dispatch picks the fastest adequate path.
---
