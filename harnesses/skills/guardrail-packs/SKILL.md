---
name: guardrail-packs
description: "Use when working on the Guardrails harness and you need capability control: Lets teams author secret patterns, approval-gate definitions, and credential-boundary policy as installable packs."
---
...
- Harness: Guardrails
- Axis: Capability
- Command: /guardrail-packs

## What This Skill Does

Lets teams author secret patterns, approval-gate definitions, and credential-boundary policy as installable packs.
...
1. Name the exact boundary: `Guardrails` / `Capability`.
...
- Custom rule packs / secret patterns (plugin)
...
2. Write the observed failure mode in one sentence: "Guardrail Packs is needed because ..."
...
- Positive test: a normal request uses `Guardrail Packs` and produces the expected controlled behavior.
...
```markdown
## Guardrail Packs Harness Update

Boundary: Guardrails / Capability
