...
description: Use when working on the Guardrails harness and you need a repeatable capability control: Lets teams author secret patterns, approval-gate definitions, and credential-boundary policy as installable packs.
---
...
- You are designing or reviewing the Guardrails harness.
...
1. Identify the controlled boundary for the Guardrails harness.
