---
name: token-cap
description: Use when working on the Route harness and you need a repeatable cost efficiency control: Enforces token ceilings per route so a single dispatch cannot overspend.
---
