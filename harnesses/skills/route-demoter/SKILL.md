---
name: route-demoter
description: Use when working on the Latency harness and you need a repeatable performance control: Sets latency SLOs and demotes routes that breach them so fast paths win.
---
