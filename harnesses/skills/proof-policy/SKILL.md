---
name: proof-policy
description: Use when working on the Proof Authority harness and you need a repeatable cost efficiency control: Scales required proof to risk tier and allows waiver shortcuts on low-risk paths to avoid over-proving cheap work.
---
