...
description: "Use when working on the Knowledge Retrieval harness and you need capability control: Adds source connectors, ranking strategies, and provenance depth so retrieval reaches new corpora with traceable lineage."
---
...
- Axis: Capability
- Command: /knowledge-connectors

## What This Skill Does

Adds source connectors, ranking strategies, and provenance depth so retrieval reaches new corpora with traceable lineage.
...
1. Name the exact boundary: `Knowledge Retrieval` / `Capability`.
...
- Source connectors (plugin)
- Ranking strategy
- Lineage / provenance depth
...
2. Write the observed failure mode in one sentence: "Knowledge Connectors is needed because ..."
...
- Positive test: a normal request uses `Knowledge Connectors` and produces the expected controlled behavior.
...
```markdown
## Knowledge Connectors Harness Update

Boundary: Knowledge Retrieval / Capability
