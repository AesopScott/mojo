---
name: index-tuner
description: Use when working on the Memory harness and you need a repeatable performance control: Tunes the recall index, decay-sweep interval, and write batching so memory reads and writes stay fast as it grows.
---
