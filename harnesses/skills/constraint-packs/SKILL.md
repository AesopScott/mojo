---
name: constraint-packs
description: "Use when working on the Policy harness and you need capability control: Lets teams author policy and install constraint packs for new route/task rules."
---
...
- Harness: Policy
- Axis: Capability
- Command: /constraint-packs

## What This Skill Does

Lets teams author policy and install constraint packs for new route/task rules.
...
1. Name the exact boundary: `Policy` / `Capability`.
...
2. Write the observed failure mode in one sentence: "Constraint Packs is needed because ..."
...
- Positive test: a normal request uses `Constraint Packs` and produces the expected controlled behavior.
...
```markdown
## Constraint Packs Harness Update

Boundary: Policy / Capability
