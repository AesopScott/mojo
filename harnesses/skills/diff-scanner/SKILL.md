---
name: diff-scanner
description: "Use when working on the Guardrails harness and you need performance control: Limits secret and permission scans to changed surfaces and precompiles rule sets so gate evaluation stays fast."
---
...
- Harness: Guardrails
- Axis: Performance
- Command: /diff-scanner

## What This Skill Does

Limits secret and permission scans to changed surfaces and precompiles rule sets so gate evaluation stays fast.
...
1. Name the exact boundary: `Guardrails` / `Performance`.
...
2. Write the observed failure mode in one sentence: "Diff Scanner is needed because ..."
...
- Positive test: a normal request uses `Diff Scanner` and produces the expected controlled behavior.
...
```markdown
## Diff Scanner Harness Update

Boundary: Guardrails / Performance
