...
description: Use when working on the Tools harness and you need a repeatable performance control: Caches results and runs safe tool calls in parallel to reduce wait.
---
...
- You are designing or reviewing the Tools harness.
...
1. Identify the controlled boundary for the Tools harness.
