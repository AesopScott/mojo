---
name: evidence-depth
description: "Use when working on the Evidence harness and you need cost efficiency control: Scales evidence depth to risk tier so low-risk output isn't over-evidenced."
---
...
- Command: /evidence-depth

## What This Skill Does

Scales evidence depth to risk tier so low-risk output isn't over-evidenced.
...
1. Name the exact boundary: `Evidence` / `Cost efficiency`.
...
2. Write the observed failure mode in one sentence: "Evidence Depth is needed because ..."
...
- Positive test: a normal request uses `Evidence Depth` and produces the expected controlled behavior.
...
```markdown
## Evidence Depth Harness Update

Boundary: Evidence / Cost efficiency
