---
name: evidence-depth
description: Use when working on the Evidence harness and you need a repeatable cost efficiency control: Scales evidence depth to risk tier so low-risk output isn't over-evidenced.
---
