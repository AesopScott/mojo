---
name: rerank-tuner
description: Use when working on the Knowledge Retrieval harness and you need a repeatable performance control: Tunes embedding model, top-k, rerank depth, and chunk size so retrieval returns the right context with less latency.
---
