...
$body .= "To complete your seller setup, open this link:\n\n";
$body .= $onboardingUrl . "\n\n";
$body .= "What happens next:\n";
$body .= "1. If the listing fee was not waived, choose PayPal or Zelle and submit your $100 payment details\n";
$body .= "2. After Mojo verifies the fee payment, review and sign the seller agreement\n";
$body .= "3. Choose a payout method such as PayPal, Zelle, Venmo, Cash App, mailed check, or another option\n";
$body .= "4. Mojo reviews your submitted product assets and connects the approved product to the marketplace checkout\n";
$body .= "5. Buyers purchase through the Mojo marketplace checkout\n\n";
