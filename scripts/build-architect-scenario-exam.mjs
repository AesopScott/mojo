  ...
  "Customer Support Resolution Agent": [
    {
      ...
      options: [
        "Ask Claude to summarize the whole transcript at each turn and trust the summary.",
        "Extract durable facts into a compact case block and re-anchor that block near the current task on each turn.",
        "Increase temperature so Claude pays attention to more of the transcript.",
        "Remove identifiers from context and ask the customer to repeat them at resolution time.",
      ],
      answer: ["B"],
  ...
  "Code Generation with Claude Code": [
    {
      ...
      options: [
        "In the user's home-level Claude config, because it loads first.",
        "In a project-level CLAUDE.md or equivalent committed repository instruction file.",
        "Only in a private slash command on the trainer's laptop.",
        "In the prompt for the next session only.",
      ],
      answer: ["B"],
  ...
  "Multi-Agent Research System": [
    {
      ...
      options: [
        ...
        "Ignore the failure if the final report sounds polished.",
        "Ask every subagent to infer what the failed subagent probably found.",
      ],
      answer: ["B"],
  ...
  "Developer Productivity with Claude": [
    {
      ...
      options: [
        ...
        "Cache every unique user question because user turns are most recent.",
        "Avoid caching stable prefixes because caching only works for tool calls.",
        "Cache retrieved results even when source freshness must be checked each turn.",
      ],
      answer: ["A", "B"],
  ...
  "Claude Code for CI/CD": [
    {
      ...
      options: [
        "Keep the vague prompt and lower the model temperature.",
        ...
        "Fail whenever the response contains cautious language.",
        "Ask for a longer explanation so reviewers can decide after the pipeline fails.",
      ],
      answer: ["B"],
  ...
  "Structured Data Extraction": [
    {
      ...
      options: [
        ...
        "Tell Claude to be more thorough without changing the schema.",
        "Skip human review because the JSON parsed successfully.",
        "Remove confidence fields so reviewers focus on the output.",
      ],
      answer: ["A", "B"],
  ...
  "Competitive intelligence report": [
    {
      ...
      options: [
        ...
        "SSE, because all MCP servers should use a remote HTTP transport.",
        "A broad shell tool, because transport selection does not affect architecture.",
        "A hidden resource, because the model should discover transport details itself.",
      ],
      answer: ["A"],
  ...
  "Internal developer assistant rollout": [
    {
      ...
      options: [
        "Merge them into one broad tool with a free-text argument.",
        "Rewrite descriptions with purpose, when-to-use guidance, example arguments, and possible error conditions.",
        "Hide two tools and let Claude discover them through MCP resources.",
        "Tell Claude to think harder before choosing a tool.",
      ],
      answer: ["B"],
