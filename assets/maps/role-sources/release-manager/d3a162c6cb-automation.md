# Automation Snapshot: reid-handoff-check

Generated from current local Codex automation runtime files.

## Current Status

- Automation id: `reid-handoff-check`
- Display name: `reid-handoff-check`
...
- `C:\Users\scott\Code\mindshare\roles\release-manager\memory.md`
...
- `G:\My Drive\Mindshare\release-manager.md`- `C:\Users\scott\Code\mindshare\roles\release-manager\memory.md`
- `G:\My Drive\Mindshare\channels\heartbeat.md`
- `G:\My Drive\Mindshare\channels\communications.md`
- `G:\My Drive\Mindshare\channels\release-management.md`
- `G:\My Drive\Mindshare\release-manager.md`
...
kind = "file_watch"
automation_id = "reid-handoff-check"
name = "reid-handoff-check"
status = "ACTIVE"
rrule = "FREQ=MINUTELY;INTERVAL=1"
target_thread_id = "019ee143-3f32-7093-9a24-acd3558fc52e"
