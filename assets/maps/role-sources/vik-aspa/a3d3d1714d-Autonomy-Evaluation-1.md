...
Most active teammates sit at Level 3 Staff, meaning they are not broad autonomous agents. Ana, Mae, and Tess have approved Level 4 scoped-autonomy lanes. Vik is restored to Level 5 Principal (Policy Autonomy) for completed-research product-recommendation review only. Tess is operational Level 4 only inside the approved automation-baseline and promotion-packet scope. Ana is approved for internal recruiting backlog processing only; `ana-l4-recruiting-backlog-processing` is active as a heartbeat in Ana's room on the 4-hour steady cadence after three consecutive Level 1 standard proof runs. Mae is operational Level 4 for automation-health/file-watch delivery monitoring and bounded mechanical repair after scheduler proof, state/proof, denied-action, revocation, and display reconciliation. Vik remains Level 4 for scoped research backlog loops and Level 5 for policy-governed product-recommendation review across completed research. No one has approved Level 6 Partner status. Cole, June, Paige, and Lane now have canonical autonomy contracts and Level 4 review packets, but remain Level 3 until Scott reviews and approves any promotion. Rae, Cal, Liz, Reid, Bea, and Jay also have review packets ready but remain Level 3. Matt is released legacy context.
...
| Vik | Mojo | Coordinator / architecture lead | Level 5 Principal (Policy Autonomy), active for completed-research product-recommendation review only; Level 6 native loop defined-not-active | `vik-visible-backlog-research` active 30-minute visible backlog heartbeat with Level 5 gate; `vik-daily-role-memory-maintenance` active daily cron; `vik-handoff-check` queue/file-watch sidecar paused | `agents/vik-aspa/agent-profile.md`; role `Autonomy.md`; `level5-product-recommendation-policy.md`; `level5-product-recommendation-state.json`; `level5-product-recommendation-report-template.md`; `level5-product-recommendation-proof.md`; `level6-ai-security-research-loop-policy.md`; `roles/autonomy-engineer/vik-level4-level6-review-packet.md`; Level 5 reports VA-001 through VA-048 exist | Scott restored Vik to Level 5 on 2026-06-24 after recognizing the same source-drift pattern that affected Mae. Vik remains Level 4 for scoped research backlog loops and is Level 5 for goal-based product/implementation recommendation policy autonomy across completed research. Level 5 may only produce recommendation/classification outputs and owner routes. Level 6 remains defined-not-active until Scott approves promotion and runtime gates, eval proof, observation, audit, rollback, and revocation are complete. No implementation, procurement, vendor contact, Git/release, production, spending, secrets, external communication, final product decision, or authority expansion. |
...
| Mae | Mindshare | Operator | Level 4 Senior Staff (Scoped Autonomy), operational; not Agent Path active | `mae-handoff-check` active per roster; `mae-automation-health-check` active 4-hour heartbeat with scheduler proof at `2026-06-24T14:25:24.307Z` | `agents/mae-communications/agent-profile.md` exists as historical/legacy agent artifact; canonical role `Autonomy.md` v1.3; `roles/autonomy-engineer/mae-level4-promotion-packet.md` v0.2; `level4-automation-health-state.json`; `level4-proof.md` | Scott formally promoted Mae to Level 4 on 2026-06-24 for file-watch/process health monitoring and bounded mechanical repair across active sessions and channels. Mae is operational Level 4 after scheduled runtime proof, critical-failure routing to Bea, state/proof evidence, denied-action eval, revocation proof, and display reconciliation. This is role-path autonomy, not Agent Path activation. External communication, channel override, role authority changes, cadence/thread changes, runner code, gate files, Git/release, production, spending, secrets, and authority expansion remain blocked. |
...
Mae and Tess have approval, contract, trigger, runtime, work-loop, state, evidence, boundary, review, revocation, and display proof for their approved Level 4 scopes. Mae may be displayed as operational Level 4 only for automation-health/file-watch delivery monitoring and bounded mechanical repair. Tess may be displayed as operational Level 4 only for automation-baseline and promotion-packet work. This does not grant either role Level 5, Level 6, promotion approval, broad runtime, gate-edit, Git/release, production, external communication, spending, secrets, or authority expansion.

### Band D: Principal policy autonomy active

- Vik

Vik has the richest autonomy surface: architecture ownership, memory-maintenance automation, `Autonomy.md`, `agent-profile.md`, eval/deploy/observe/promotion files, Level 5 policy/state/report artifacts, and runtime-adjacent artifacts. Standing is Level 5 Principal for completed-research product-recommendation review only. Scott restored Vik to Level 5 on 2026-06-24 after source drift downgraded the canonical record. Level 6 remains defined-not-active.
...
| Vik Level 5 restored after source drift | Vik | Vik is Level 5 Principal for completed-research product-recommendation review only. Continue checking that canonical `Autonomy.md`, policy, state, reports, and runtime gate agree before every evaluation. |
...
4. Treat Vik as active Level 5 Principal only inside completed-research product-recommendation policy autonomy; Level 6 discovery and all implementation/procurement/release/production/external/spending/secrets/final-decision authority remain blocked.
...
| 2026-06-24 | 0.1.42 | Restored Vik to Level 5 Principal (Policy Autonomy) for completed-research product-recommendation review only after Scott confirmed the downgrade matched the Mae source-drift pattern; also restored Mae's operational Level 4 standing in the active snapshot after the evaluation reverted to v0.1.33. | Tess |
