...
| Phase | Skill | Purpose |
|---|---|---|
| M0 | `/foundation` | Start Project Foundation with project intent, notes scaffold, source inventory, evidence index, assumptions, decisions, RAG-readiness, and remembered notes/RAG locations. |
